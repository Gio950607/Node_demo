...
//	go func() {
//		statusQue = make(chan string, 1000000)
//		performanceQue = make(chan string, 1000000)
//		warningQue = make(chan string, 1000000)
//		for {
//			if InitValue.Group != "Zombie" {
//				select {
//				case msg := <-statusQue:
//					log.Println("Status.txt:")
//					logFile := OpenLogFile(InitValue.NodeName + "-Status")
//					defer logFile.Close()
//					WriteLog(logFile, msg)
//				case msg := <-performanceQue:
//					log.Println("Performance.txt:")
